  ...
  return (
    <section id="jobs" style={{ padding: '96px 64px', background: 'white' }} className="sec-jobs">
      ...
      <div className="rv" style={{ maxWidth: 580, margin: '0 auto', textAlign: 'center', background: 'var(--bg)', borderRadius: 20, padding: 48, border: '1px solid var(--border)' }}>
        ...
        <a href="mailto:CustomerService@dibrahcare.com" style={{ display: 'inline-block', background: 'var(--dark)', color: '#F6F0D7', fontSize: '.85rem', fontWeight: 700, padding: '12px 28px', borderRadius: 8, transition: 'background .2s' }}>
          قدّمي طلبك الآن
        </a>
      </div>
