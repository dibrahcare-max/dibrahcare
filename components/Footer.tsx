        ...
        <div style={{ display: 'grid', gridTemplateColumns: '2fr 1fr 1fr 1.5fr', gap: 40, marginBottom: 40, paddingBottom: 40, borderBottom: '1px solid rgba(227,238,213,.08)' }} className="footer-top">
          ...
          <div>
            ...
            <ul style={{ listStyle: 'none', display: 'flex', flexDirection: 'column', gap: 9 }}>
              {([['من نحن','/about'],['خدماتنا','/#services'],['الباقات','/#packages'],['الأسئلة الشائعة','/#faq'],['تواصل معنا','/contact'],['بوابة الداعمين','/supporters'],['سياسة الخصوصية','/privacy'],['الشروط والأحكام','/terms']] as [string,string][]).map(([l,h]) => (
          ...
          <div>
            ...
            {[
              ...
              { icon: <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" style={{width:16,height:16}}><rect x="2" y="4" width="20" height="16" rx="2"/><path d="m2 7 10 7 10-7"/></svg>, val: 'CustomerService@dibrahcare.com' },
