...
const services = [
  ...
  },
  {
    ...
    note: 'ملاحظة: هذه الخدمة تُقدّم لكبيرات السن (نساء)',
  },
  {
...
export default function ServicesPage() {
  return (
    <>
      ...
      {/* Service Cards */}
      <section id="services-list" style={{ padding: '0 64px 96px', background: 'var(--bg)' }} className="sec-svc-cards">
