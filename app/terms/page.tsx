...
const sections = [
  ...
  },
  {
    ...
    title: 'التواصل معنا',
    content: 'لأي استفسارات حول هذه الشروط، يمكنكم التواصل عبر البريد الإلكتروني: CustomerService@dibrahcare.com أو الاتصال على الرقم: 966535977511+ وسيسعدنا الرد على جميع استفساراتكم.',
  },
]
