...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    images: [
      {
        url: 'https://dibrahcare.com/images/dibrah-logo.png',
        width: 1200,
        height: 630,
  ...
  twitter: {
    ...
    description: 'كوادر سعودية مؤهلة لرعاية أطفالك وكبار السن في الرياض',
    images: ['https://dibrahcare.com/images/dibrah-logo.png'],
  },
}
