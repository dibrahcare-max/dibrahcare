...
const sections = [
  ...
  },
  {
    ...
    title: 'التواصل معنا',
    content: 'لأي استفسار يتعلق بسياسة الخصوصية أو كيفية معالجة بياناتك، يمكنكم التواصل عبر البريد الإلكتروني: CustomerService@dibrahcare.com، أو عبر صفحة (تواصل معنا) على الموقع. نلتزم بالرد على جميع استفساراتكم خلال مدة زمنية وجيزة.',
  },
]
